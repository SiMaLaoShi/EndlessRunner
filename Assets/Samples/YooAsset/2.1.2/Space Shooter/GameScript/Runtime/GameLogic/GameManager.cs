...
public class GameManager
{
    ...
    private GameManager()
    {
        ...
        _eventGroup.AddListener<SceneEventDefine.ChangeToStartScene>(OnHandleEventMessage);
    }
    ...
    private void OnHandleEventMessage(IEventMessage message)
    {
        switch (message)
        {
            ...
            case SceneEventDefine.ChangeToBattleScene:
                ...
                break;
            case SceneEventDefine.ChangeToMainScene:
                var sceneHandle = YooAssets.LoadSceneAsync("Main");
                sceneHandle.Completed += handle =>
                {
                    YooAssets.StartOperation(new GameLogic());
                };
                break;
            case SceneEventDefine.ChangeToStartScene:
                YooAssets.LoadSceneAsync("Start");
                break;
        }
    }
}